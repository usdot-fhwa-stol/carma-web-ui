...
curl -o /opt/carma/Pictures/CARMA_icon_color.png  https://raw.githubusercontent.com/usdot-fhwa-stol/carma-web-ui/integration/ui/install_scripts/Pictures/CARMA_icon_color.png 
