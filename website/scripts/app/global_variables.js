...
//Route EVENT 
const  ROUTE_LOADED = 0;
const  ROUTE_SELECTED = 1;
const  ROUTE_STARTED = 2;
const  ROUTE_COMPLETED = 3;
const  ROUTE_DEPARTED = 4;
const  ROUTE_ABORTED = 5;
const  ROUTE_GEN_FAILED = 6;
