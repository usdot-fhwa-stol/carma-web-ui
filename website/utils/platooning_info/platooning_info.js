function createPlatooningInfo(platooning_state,host_vehicle_position,desired_gap,actual_gap,leader_vehicle_id,platoon_id,platoon_applied_speed)
{
    ...
    p_host_desired_gap.innerHTML = "DESIRED GAP FROM LEADER: " + desired_gap;
    ...
    p_host_actual_gap.innerHTML = "ACTUAL GAP FROM LEADER: " + actual_gap;
    ...
    p_platoon_applied_speed.innerHTML = "PLATOON APPLIED SPEED: " + platoon_applied_speed;
