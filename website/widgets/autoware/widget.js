...
***/
CarmaJS.registerNamespace("CarmaJS.WidgetFramework.Autoware");

CarmaJS.WidgetFramework.Autoware = (function () {
        ...
        var installfoldername = 'widgets/autoware/';
        ...
        ***/
        $.widget("CarmaJS.autowareSpeedLimit", {
            _create: function() {
        ...
        });//CarmaJS.autowareSpeedLimit

        $.widget("CarmaJS.autowareSpeedCmd", {
            _create: function() {
        ...
        });//CarmaJS.autowareSpeedCmd

        /*
        * Create the speedometer.
        */
        $.widget("CarmaJS.autowareSpeedometer", {
            _create: function() {
        ...
        ***/
        var loadCustomWidget = function(container) {
            ...
            container.autowareSpeedLimit();
            container.cruisingSpeedLimit("setDefaultSpeedLimit",null);
            container.autowareSpeedLimit("showActiveRoute",null);
            container.autowareSpeedLimit("checkRouteState",null);

            container.autowareSpeedCmd();
            container.autowareSpeedCmd("showSpeedAccelInfo",null);

            container.autowareSpeedometer();
            container.autowareSpeedometer("showActualSpeed",null);
        };
...
})(); //CarmaJS.WidgetFramework.Autoware